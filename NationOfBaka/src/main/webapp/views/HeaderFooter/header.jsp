...
<body>
	...
	<header class="header">
					...
					<div class="header__nav">
						...
						<form class="d-flex" role="search">
							...
							<input class="form-control border-start-0 border-end-0 rounded-start-0 rounded-end-0" type="search" placeholder="Recherchez..." aria-label="Search">
								<a type="submit"
									class="search-switch btn btn-outline-success rounded-start-0 rounded-end"><span class="icon_search"></span></a>
						</form>
						</nav>
					</div>
				</div>
					...
					<div class="header__right">
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							<c:if test="${empty Usercurrent}">
								...
								<a data-toggle="modal" data-target="#myModal" class="nav-link d-inline"><span class="icon_profile"></span>
								<i class="bi bi-box-arrow-in-right"></i></a>
							</c:if>
							<c:if test="${Usercurrent.role.role == 'Client'}">
								<ul class="navbar-nav me-auto mb-2 mb-lg-0">
									<li class="nav-item dropdown me-3">
											<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 
												<i class="bi bi-person-check-fill"></i> Bonjour, <c:out value="${currentUser.getNickname()}" />
											</a>
		...
		<c:if test="${(empty userCurrent.id) || (userCurrent == 'Client')}">
						...
						<div class="container">
							<div class="container">
								<div class="row">
									<div class="col-lg-6">
										<div>
											<form method="post" onsubmit="checkformML(event)"
												action="login" name="formML" id="loginForm">
												...
												<button type="submit" class="btn btn-primary loginForm">Se
													connecter</button>
											</form>
										</div>
									</div>
